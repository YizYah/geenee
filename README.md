...
geenee/0.1.7 linux-x64 node-v15.8.0
$ geenee --help [COMMAND]
USAGE
  $ geenee COMMAND
...
...
_See code: [src/commands/check.ts](https://github.com/YizYah/geenee/blob/v0.1.7/src/commands/check.ts)_
...
_See code: [src/commands/generate.ts](https://github.com/YizYah/geenee/blob/v0.1.7/src/commands/generate.ts)_
...
_See code: [src/commands/settings.ts](https://github.com/YizYah/geenee/blob/v0.1.7/src/commands/settings.ts)_
<!-- commandsstop -->
